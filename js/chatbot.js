...
(function () {
  ...
  var PAGE_CHIPS = {
    ...
    'markets.html':     [{ label:'🏥 Medical Sector',        query:'medical pharma healthcare' },       { label:'💡 Electronics & LED',  query:'electronics led lighting charger' },     { label:'⚙️ Our Services',      query:'services manufacturing' },        { label:'📬 Contact Us',         query:'contact' }],
    'end-to-end.html':     [{ label:'⚙️ Our Services',          query:'manufacturing services' },          { label:'✅ Quality Systems',    query:'quality certification iso' },            { label:'🏥 Medical Facility',   query:'medical cleanroom' },             { label:'📬 Contact Us',         query:'contact' }],
    'quality.html':        [{ label:'🏥 ISO 13485 Medical',     query:'medical iso 13485 cleanroom' },     { label:'🏭 End-to-End',         query:'end to end lifecycle stages' },          { label:'📋 Regulatory Support', query:'regulatory compliance documentation' }, { label:'📬 Request a Quote', query:'contact quote' }],
    'case-studies.html':   [{ label:'🤝 Our Clients',           query:'clients' },                         { label:'🌐 Markets',         query:'industries sectors' },                   { label:'⚙️ Our Services',      query:'services' },                      { label:'📬 Start a Project',    query:'contact quote' }],
    'clients.html':        [{ label:'📊 Case Studies',          query:'case studies success stories' },    { label:'🌐 Markets',         query:'industries sectors' },                   { label:'⚙️ Our Services',      query:'services manufacturing' },        { label:'📬 Work With Us',       query:'contact quote' }],
  ...
  var FOLLOW_UP = {
    ...
    clients      : [{ label:'📊 Case Studies',          query:'case studies success' }, { label:'🌐 Markets',        query:'industries sectors' }, { label:'📬 Work With Us',      query:'contact quote' }],
    ...
    'case-studies': [{ label:'🤝 Our Clients',          query:'clients' }, { label:'🌐 Markets',        query:'industries sectors' }, { label:'📬 Start a Project',   query:'contact quote' }],
